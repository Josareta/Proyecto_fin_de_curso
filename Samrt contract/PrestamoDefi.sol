...
contract prestamoDefi {
   ...
   struct Cliente {
    ...
    // función para interactuar con python en la verificación del alta del prestamista, devolviendo el mapping
    
    function esPrestamistaDadoDeAlta(address prestamista) public view returns (bool) {
        return empleadosPrestamista[prestamista];
    }

    function esClienteDadoDeAlta(address cliente_address) public view returns (bool) {
        Cliente storage cliente = clientes[cliente_address];
